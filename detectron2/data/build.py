...
__all__ = [
    ...
    "build_detection_train_source_loader",
]
...
def build_detection_train_source_loader(cfg, mapper=None):
    """
    A data loader is created by the following steps:
    ...
    dataset_dicts = get_detection_dataset_dicts(
        ...
        proposal_files=cfg.DATASETS.PROPOSAL_FILES_TRAIN_SOURCE if cfg.MODEL.LOAD_PROPOSALS else None,
    )
    dataset = DatasetFromList(dataset_dicts, copy=False)
