...
from .rpn_head import RPNFeat


@register
class IIRRPNHead(nn.Layer):
    """
    ...
    def __init__(self,
                 ...
                 in_channel=1024,
                 export_onnx=False):
        super(IIRRPNHead, self).__init__()
    ...
    def forward_weak(self, feats, inputs):
        ...
        rois, rois_num, obj_logits = self._gen_proposal_w_obj(scores, deltas, anchors, inputs)

        return rois, rois_num, obj_logits
    ...
    def _gen_proposal_w_obj(self, scores, bbox_deltas, anchors, inputs):
        """
        ...
        for i in range(batch_size):
            ...
            bs_rois_prob_collect.append(topk_prob)
        ...
        return output_rois, output_rois_num, output_rois_prob
